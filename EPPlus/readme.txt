...
.NET Core uses a preview of Common, so be aware of that. We will update it as Microsoft releases newer versions.
Common requires libgdiplus to be installed on non-Windows operating systems.
...
4.5.3.2
* Added a target build for .NET Core 2.1 (netcoreapp2.1) with Common 4.6.0-preview6.19303.8 
...
4.5.3
* Upgraded Common for .NET Core to 4.5.1
...
4.5.2.1
* Upgraded Common for .NET Core to 4.5.0
* Fixed problem with Apostrophe in worksheet name

4.5.2
* Upgraded Common to 4.5.0-rc1
...
* Upgraded Common to 4.5.0-preview1-26216-02
...
* Replaced CoreCompat.v2 with Common
