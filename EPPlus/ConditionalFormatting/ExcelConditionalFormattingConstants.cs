...
namespace OfficeOpenXml.ConditionalFormatting
{
    ...
    internal static class ExcelConditionalFormattingConstants
  {
        ...
        {
            internal static readonly SKColor CfvoHighValue = new SKColor(0xFF, 0x63, 0xBE, 0x7B);
            internal static readonly SKColor CfvoLowValue = new SKColor(0xFF, 0xF8, 0x69, 0x6B);
            internal static readonly SKColor CfvoMiddleValue =new SKColor(0xFF, 0xFF, 0xEB, 0x84);
        }
